...
import { deleteIngredient, loadAllIngredients } from "../store/ingredients";

const ConfirmDeleteIngredientModal = ({ ingredientId }) => {
...
export default ConfirmDeleteIngredientModal;
