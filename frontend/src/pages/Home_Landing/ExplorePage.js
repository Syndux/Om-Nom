...
const Explore = () => {
  ...
  return (
    <>
      <div className="m-3 h-[calc(100dvh-100px)] w-full overflow-x-hidden overflow-y-scroll rounded-xl bg-main-bg shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px] dark:bg-main-dark-bg dark:shadow-[rgba(233,_233,_224,_0.1)_0px_0px_16px]">
        {sessionUser ? (
          loaded && (
            <>
        ...
        {sessionUser ? (
          loaded && (
            <>
              ...
              {ingredients
                .filter((ingredient) => ingredient.creatorId === sessionUser.id)
                .map((ingredient) => (
                  <div
                    key={ingredient.id}
                    className="flex justify-between border-t px-10 py-3 duration-100 ease-in hover:scale-[1.01] hover:shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px] dark:hover:shadow-[rgba(205,_205,_150,_0.15)_0px_2px_5px_0px,_rgba(255,_255,_255,_0.3)_0px_1px_1px_0px]"
