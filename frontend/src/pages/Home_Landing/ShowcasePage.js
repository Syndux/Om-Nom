...
const ShowcasePage = () => {
  ...
  return (
    <div className="m-3 flex h-[calc(100dvh-100px)] w-full flex-col items-center overflow-hidden rounded-xl bg-main-bg text-center shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px] dark:bg-main-dark-bg dark:shadow-[rgba(233,_233,_224,_0.1)_0px_0px_16px]">
      ...
      <div className="mt-16 flex justify-center sm:relative sm:flex-none">
        <img
          src={homeSrc}
          alt="homepage preview"
          className="w-[90%] max-w-none rounded-md border shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px] dark:shadow-[rgba(233,_233,_224,_0.1)_0px_0px_16px] sm:absolute sm:-left-[15rem] sm:w-[80rem]"
        />
      </div>
    </div>
  );
